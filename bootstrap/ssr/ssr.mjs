...
function Providers({
  ...
  return /* @__PURE__ */ jsx(NextUIProvider, { children: /* @__PURE__ */ jsx(ThemeProvider, { attribute: "class", defaultTheme, enableSystem: true, children }) });
}
...
createServer((page) => createInertiaApp({
  ...
  resolve: (name) => resolvePageComponent(`./pages/${name}.jsx`, /* @__PURE__ */ Object.assign({ "./pages/error.jsx": () => import("./assets/error-e6447670.mjs"), "./pages/hello.jsx": () => import("./assets/hello-a63082ee.mjs") })),
  setup: ({
    App,
    props
  }) => {
    ...
    return /* @__PURE__ */ jsx(Providers, { defaultTheme: props.initialPage.props.theme, children: /* @__PURE__ */ jsx(App, { ...props }) });
  }
}));
